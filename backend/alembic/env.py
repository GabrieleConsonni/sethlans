"""
Alembic env per Tabula — supporta SQLite (default) e PostgreSQL.
Con PostgreSQL: schema dedicato `tabula`, schema_translate_map, version table nello schema.
...
from db import IS_POSTGRES, SCHEMA, TABULA_DB_URL  # noqa: E402
...
def run_migrations_online() -> None:
    ...
    connectable = create_engine(TABULA_DB_URL, poolclass=pool.NullPool, connect_args=connect_args)
