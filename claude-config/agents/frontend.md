...
Se l'orchestratore ti passa un `task_id` (ed eventualmente `TABULA_API_URL`), rifletti il tuo stato sulla board seguendo `~/.claude/tabula-protocol.md`. Il tuo nome agente è **frontend**.
